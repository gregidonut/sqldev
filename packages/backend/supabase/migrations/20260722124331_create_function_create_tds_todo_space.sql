...
BEGIN
    INSERT INTO public.tds_todo_spaces
        DEFAULT
    VALUES
    RETURNING tds_todo_spaces.todo_space_id
        INTO v_todo_space_id;

    INSERT INTO public.tds_todo_spaces_roles (todo_space_id, user_id, role)
    VALUES (v_todo_space_id, v_user_id, 'owner');

    INSERT INTO public.tds_todo_space_config (todo_space_id, public)
    VALUES (v_todo_space_id, p_public);
