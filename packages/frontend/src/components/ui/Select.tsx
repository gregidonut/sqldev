...
import type {TextFieldProps} from "@/components/ui/TextField.tsx";
...
export function Select<T extends object>(
    {label, description, errorMessage, children, items, ref, ...props}: SelectProps<T> & { ref?: React.Ref<HTMLDivElement> }
) {
    return (
        <AriaSelect {...props}
